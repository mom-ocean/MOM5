...
if( $type == MOM_solo ) then
    ...
    set libs = "$executable:h:h/lib_ocean/lib_ocean.a $executable:h:h/lib_FMS/lib_FMS.a $executable:h:h:h:h:h/libauscom/libauscom.a -L$cplLib/ -lpsmile.MPI1 -lmct -lmpeu -lscrip"
