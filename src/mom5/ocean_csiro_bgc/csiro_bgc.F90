...
! arrays for air-sea fluxes
  ...
  real, _ALLOCATABLE, dimension(:,:)         :: csat_acsurf _NULL
  real, _ALLOCATABLE, dimension(:,:)         :: csurf _NULL
  real, _ALLOCATABLE, dimension(:,:)         :: acsurf _NULL
  real, _ALLOCATABLE, dimension(:,:)         :: dpco2 _NULL
  real, _ALLOCATABLE, dimension(:,:)         :: pco2surf _NULL
  real, _ALLOCATABLE, dimension(:,:)         :: paco2surf _NULL
  real, _ALLOCATABLE, dimension(:,:)         :: pco2atm _NULL
  real, _ALLOCATABLE, dimension(:,:)         :: paco2atm _NULL
  real, _ALLOCATABLE, dimension(:,:)         :: det_sediment _NULL       ! mmol(NO3) m-2 in DET sitting at base of column as sediment. 
  real, _ALLOCATABLE, dimension(:,:)         :: caco3_sediment _NULL     ! mmol(CaCO3) m-2 sitting at base of column as sediment. 
  real, _ALLOCATABLE, dimension(:,:)         :: det_sed_remin _NULL      ! mmol(NO3) m-2 s-1, rate of remineralisation of DET in sediment.  
  real, _ALLOCATABLE, dimension(:,:)         :: caco3_sed_remin _NULL    ! mmol m-2 s-1, rate of remineralisation of CaCO3 in sediment.  
  real, _ALLOCATABLE, dimension(:,:)         :: det_sed_depst _NULL      ! mmol(NO3) m-2 s-1, rate of deposition of DET in sediment.  
  real, _ALLOCATABLE, dimension(:,:)         :: caco3_sed_depst _NULL    ! mmol m-2 s-1, rate of deposition of CaCO3 in sediment.  
  real, _ALLOCATABLE, dimension(:,:)         :: sio2 _NULL
  real, _ALLOCATABLE, dimension(:,:)         :: po4 _NULL
  real, _ALLOCATABLE, dimension(:,:,:)       :: vstf _NULL
